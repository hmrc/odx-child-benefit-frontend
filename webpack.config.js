  ...
  pluginsToAdd.push(
    new CopyWebpackPlugin({
      patterns: [
        ...
        {
          from: './sdk-local-component-map.js' /* New SDK packaging expects this local component map to be includ-ed; to be generated by DXCB */,
          to: './'
        },
        {
    ...
    module: {
      rules: [
        ...
        },
        {
          test: /\.d\.ts$/,
          use: [],
          exclude: /node_modules/ // Exclude TypeScript declaration files
        },
        {
          test: /\.map$/,
          use: [],
          exclude: /node_modules/ // Exclude source maps
        }
      ]
    },

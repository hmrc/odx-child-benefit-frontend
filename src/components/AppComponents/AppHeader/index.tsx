...
export default function AppHeader(props: AppHeaderProps) {
  const { handleSignout, appname, hasLanguageToggle, betafeedbackurl } =
    props;
  ...
  const urlSkipContent = `${document.location.href}#main-content`;
              ...
              <p className='govuk-phase-banner__content'>
                ...
                <span className='govuk-phase-banner__text'>
                  ...
                  <a
                    ...
                    href={
                      betafeedbackurl ||
                      `${hmrcURL}contact/beta-feedback?service=463&referrerUrl=${referrerURL}`
                    }
                  >
